        ...
        <section>
            <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="item active"><img src="img/sl1.jpg" > </div>
                    <div class="item"><img src="img/sl2.jpg"></div>
                    <div class="item"><img src="img/sl3.jpg" > </div>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="col-r">
                    ...
                    <ul class="col-r2">
                        ...
                        <li><a href="#">News for up-to-the-minute news, breaking news, video, audio and feature stories. </a></li>
                    </ul>
                </div>
                <div class="col-l">
                    <div class="col-l1">